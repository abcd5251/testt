    ...
    while True:
        ...
        for j in range(len(scene_info.bricks)):
            if scene_info.bricks[j][1]-ball_y>0 :
               if ball_x+((scene_info.bricks[j][1]-ball_y)/vectors_y)*vectors_x==scene_info.bricks[j][0]: 
        ...
        if len(scene_info.hard_bricks)!=0:
            for j in range(len(scene_info.hard_bricks)):
                if scene_info.hard_bricks[j][1]-ball_y>0 :
                    if ball_x+((scene_info.hard_bricks[j][1]-ball_y)/vectors_y)*vectors_x==scene_info.hard_bricks[j][0]: 
